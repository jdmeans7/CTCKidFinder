...
namespace Chirst_Temple_Kid_Finder.Controllers
{
    public class CodeAssignTablesController : Controller
    {
        ...
        // GET: CodeAssignTables/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: CodeAssignTables/Create
        ...
        // POST: CodeAssignTables/Delete/5
